...
The mirror test is among the most famous tests in animal behavior. It is used to see if animals can recognize themselves when they look in a mirror.
To recognize themselves in a mirror, they must be self-aware. Note that the inverse is not necessarily true - animals that do *not* recognize themselves in a mirror are not, necessarily, lacking self-awareness. If, for example, they are not particularly visual animals, then it's not likely to work. Also, if they can recognize themselves but when they do, don't display any behavior that we associate with self-recognition, it wouldn't work.

However, there are lots of behaviors we're seeing. For example, chimpanzees like to look in their mouths and at their teeth. Baboons seem roughly equally visual as chimpanzees (the bright hindquarters seem to suggest this), but do not display the same behavior. Maybe these findings *do* point to a lack of self-awareness in baboons.
