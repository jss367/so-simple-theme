...
To recognize themselves in a mirror, they must be self-aaware. Note that the inverse is not necessarily true - animals that do *not* recognize themselves in a mirror are not, necessarily, lacking self-awareness. If, for example, they are not particularly visual animals, then it's not likely to work. Also, if they can recognize themselves but whenn they do don't display any behavior that we associate with self recognition, it wouldn't work.
