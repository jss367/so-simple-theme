...
The mirror test is among the most famaous tests in animal behavior. It is used to see if animals can recognize themselves when they look in a mirror.
To recognize themselves in a mirror, they must be self-aaware. Note that the inverse is not necessarily true - animals that do *not* recognize themselves in a mirror are not, necessarily, lacking self-awareness. If, for example, they are not particularly visual animaals, then it's not likely to work. Also, if they can recognize themselves but whenn they do don't display any behavior that we associate with self recognition, it wouldn't work.

However, there are lots of behaviors we're seeing. For example, chimpanzees like to look in their mouths and at their teeth. Baboon seem roughly equally visual as chimpanzees (the bright hindquarters seem to suggest this), but do not display the same behavior. Maybe these findings *do* point to a lack a self-awareness in baboons.

https://www.youtube.com/watch?v=OsoNKlyFtpI


there is risk of fail negatives here
...
Seeing a reduction in agressive behavior alone would be significant. Noteably, new calendonian crows always react agressively. Growing up the was a cardinal that always saw its reflection and would attack it. This behavior continued for a long time, with no indication that it had ever figured out that it was looking at itself.
...
Youngest chimp I'm aware of to show self awareness was Megan, at 3 years and 3 months old (Self-Recognition in Chimpanzees (Pan troglodytes): Distribution,
Ontogeny, and Patterns of Emergence)

There's no doubt that you can still be self-aware and still "fail" a mirror test.

The mirror test is easay to criticise, but as far as tests of self-awareness go, I'm not sure what we've got that's better.


Some animals aarae not as vision-based asa humans, or would only recognize themselves in a modality of senses.

Could we use another sense for the mirror test?
Smell --  too diffuse. They might think that they aarae the origin, has been done with dogs though... inconclusive results
Taste -- seems unlikely, but could try it
Sound -- I can't even recognize my own voice. My internal voice is  different thaan external
...
I aam on the lookout for animals using their reflection from water or ice as a natural mirror, but I haven't seen that yet.
...
I don't think they pass, although the recognnnize what a mirror is
...
Hamadryas baboon have been tested and not passed
